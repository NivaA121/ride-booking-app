  ...
  return (
    <div className="relative flex justify-center items-center min-h-screen bg-dark-900 overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-1/4 -left-32 w-96 h-96 bg-accent-purple/20 rounded-full blur-[120px] animate-pulse-slow" />
        <div className="absolute bottom-1/4 -right-32 w-96 h-96 bg-primary-500/20 rounded-full blur-[120px] animate-pulse-slow" />
